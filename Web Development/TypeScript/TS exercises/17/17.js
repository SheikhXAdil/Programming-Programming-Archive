...
// Program 16
var guests_17 = ["Daim", "Mouzzam", "Bilal", "Soban"];
var message_17 = "You are invited to a dinner ";
for (var i = 0; i < guests_17.length; i++) {
    var element = guests_17[i];
...
console.log('\n');
for (var i = 0; i < guests_17.length - 2; i++) {
    console.log("Sorry, I can't invite you to dinner " + guests_17[i]);
}
for (var i = 0; i < guests_17.length + 1; i++) {
    guests_17.shift();
}
console.log('\n');
for (var i = 0; i < guests_17.length; i++) {
