...
let courses = ["Web 3.0 & Metaverse (price:6000)", "AI (price:5500)", "Blockchain (price:5000)", "Internet of things (price:4500)"];
const enroll = async (student, courses) => {
...
const loggedinTasks = async (student) => {
    console.clear();
    let running = true;
